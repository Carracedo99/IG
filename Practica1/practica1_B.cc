...
void draw_objects()
{
    ...
    //AQUI INDICAMOS LO QUE DIBUJAMOS
     
    //piramide.draw_puntos(1.0,0.5,0.0,5);
    //cubo.draw_puntos(0.0, 1.0, 0.0, 5);

    //piramide.draw_aristas(0.0, 1.0, 0.0, 5);
    cubo.draw_aristas(0.0, 1.0, 0.0, 5);

    //piramide.draw_solido(0.0, 1.0, 0.0);
