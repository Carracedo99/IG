...
GLfloat vertices9[] = { 0,0,1, 0,0,0, 	1,0,0,	1,0,1	};		//suelo


GLfloat texVertices[] = {0.0,0.0,	1.0,0.0,	1.0,1.0,	0.0,1.0};
GLfloat texVertices2[] = {0.0,0.0,	1.0,0.0,	1.0,1.0,	0.0,1.0};
GLfloat texVertices3[] = {0.0,0.0,	1.0,0.0,	1.0,1.0,	0.0,1.0};
GLfloat texVertices4[] = {0.0,0.0,	1.0,0.0,	1.0,1.0,	0.0,1.0};
GLfloat texVertices5[] = {0.0,0.5,	0.5,0.5,	0.5,0.0,	0.0,0.0};
GLfloat texVertices6[] = {0.0,0.5,	0.5,0.5,	0.5,0.0,	0.0,0.0};
GLfloat texVertices7[] = {0.0,1.0,	0.5,0.5,	1.0,1.0};
GLfloat texVertices8[] = {0.0,1.0,	0.5,0.5,	1.0,1.0};
GLfloat texVertices9[] = {0.0,0.0,	1.0,0.0,	1.0,1.0,	0.0,1.0};
...
void Init(int argc, char **argv){
   ...
   prepara_textura("./pared.jpeg", &textura_id);
   prepara_textura("./suelo.jpeg", &textura_id2);
   prepara_textura("./tejas2.jpeg", &textura_id3);
   prepara_textura("./tejas.jpeg", &textura_id4);
...
void dibuja (void)
{
   ...
   glBindTexture(GL_TEXTURE_2D, textura_id4);
